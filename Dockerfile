...
#RUN gpg --keyserver www.gpg-keyserver.de --recv-keys F758CE318D77295D
#RUN gpg --export --armor F758CE318D77295D | apt-key add -

#RUN gpg --keyserver www.gpg-keyserver.de --recv-keys 2B5C1B00
#RUN gpg --export --armor 2B5C1B00 | apt-key add -

#RUN gpg --keyserver www.gpg-keyserver.de --recv-keys 0353B12C
